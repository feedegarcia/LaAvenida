<script setup>
    ...
    // Funci n para seleccionar sucursal con control de estado
    const seleccionarSucursal = (sucursal) => {
        // Verificar si realmente es un cambio de sucursal
        if (sucursalSeleccionada.value?.id === sucursal.id) {
            console.log('Misma sucursal, ignorando selecci n');
            return;
        }
    ...
    onMounted(() => {
        ...
        // Si hay m s de una, intentar cargar la  ltima seleccionada
